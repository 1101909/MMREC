"""Kaggle runner for selected MMRec models on modern Python.

Run this file from the repository root or from ``src``. It executes each model
in a separate Python process so one failure does not stop the remaining models.
"""
...
def main() -> None:
    ...
    summary_path = run_dir / f"summary-{timestamp}.csv"
